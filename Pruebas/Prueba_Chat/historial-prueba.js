var element = $('.floating-historial');
var myStorage = localStorage;

if (!myStorage.getItem('historialID')) {
    myStorage.setItem('historialID', createUUID());
}
...
function openElement() {
    ...
    element.find('.historial').addClass('enter');
...
function closeElement() {
    element.find('.historial').removeClass('enter').hide();
    element.find('>i').show();
    ...
    setTimeout(function() {
        element.find('.historial').removeClass('enter').show()
        element.click(openElement);
    }, 500);
}
...
function loadMessages() {
    ...
    if(otherUser==0){
      ...
      messagesContainer.append("<li>Por favor, selecione un historial</li>")
      return;
    }
 ...
 messagesContainer.append([
  ...
  messagesContainer.empty();
  messagesContainer.append("<li>Cargando el historial, por favor espere...</li>")
